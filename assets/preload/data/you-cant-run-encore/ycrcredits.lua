...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	ArtistName1 = 'Noveni'	
	ArtistName2  = 'FenixTheCat'
	ArtistName3  = 'Torresmmo'
  --ArtistName4 = 'Sonic.EXE Artist Team' Im sorry but i cannot figure out how add a 4th name :(
	
	MusicianName1 = 'YeeYeeMan - FLP'
