	   ...
	   //idk
		...
		else
		{
			switch (daSong)
			{
				...
				case 'too-slow' | 'you-cant-run' | 'triple-trouble' | 'endless' | 'endless-og' | 'endeavours' | 'cycles' | 'malediction' | 'prey' | 'fight-or-flight'| 'substantial' | 'digitalized' | 'round-a-bout' | 'relax' | 'hedge' | 'manual-blast' | 'shocker' | 'hollow' | 'b4cksl4sh':
